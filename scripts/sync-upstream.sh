...
# 註：自 upstream v2.1.0 起，codex-imagegen 已合併進上游
#     （packages/baoyu-codex-imagegen/ + skills/baoyu-image-gen/ --provider codex-cli），
#     對應 TW 自有副本（scripts/codex-imagegen/*、docs/codex-imagegen-backend.md、
#     .github/workflows/codex-imagegen-tests.yml）已交還上游，從清單移除。
TW_FILES=(
...
# 確保 TW 腳本可執行
chmod +x scripts/apply-customizations.sh scripts/convert-to-traditional.sh scripts/sync-upstream.sh 2>/dev/null || true
