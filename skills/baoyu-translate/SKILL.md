...
description: >-
  This skill should be used when the user asks to "translate", "翻譯", "精翻", "translate article",
  "translate to Chinese", "translate to English", "改成中文", "改成英文", "convert to Chinese",
  "localize", "本地化", "refined translation", "精細翻譯", "proofread translation", "快速翻譯", "快翻",
  "這篇文章翻譯一下", or provides a URL/file with translation intent. Supports three modes
